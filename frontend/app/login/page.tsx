...
import { Mail, Lock, Sparkles, ArrowRight, Apple } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        >
          <div className="inline-block p-4 rounded-2xl glass-card mb-4">
            <div className="h-16 w-16 rounded-xl bg-gradient-to-br from-purple-600 to-pink-600 flex items-center justify-center mx-auto">
